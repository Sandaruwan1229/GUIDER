...
import com.SEproject.guiderapp.adapter.AppAdapter;
import com.SEproject.guiderapp.data.AppColumns;
import com.SEproject.guiderapp.model.App;
...
import static com.SEproject.guiderapp.data.AppProvider.Apps.URI_APPS;
...
public class MainActivity extends AppCompatActivity implements AppAdapter.AppOnClickHandler {
    ...
    ImageView mainMenus,settingsMenus,graphMenus,starMenus;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        starMenus = findViewById(R.id.imageView5);
        if (mAppsList != null) {
        ...
        settingsMenus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        graphMenus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        starMenus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
